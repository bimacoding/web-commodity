<div class="col-sm-12">
    <div class="white-box">
        ...
        <?php $attributes = array('class'=>'form-horizontal','role'=>'form','autocomplete'=>'off'); echo form_open_multipart('frontend/tambah_menu',$attributes); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <select class="form-control" name="type_menu" id="type_menu" onchange="menu_type()">
            ...
            <div class="form-group row" id="type_custom">
                ...
                <div class="col-10">
                    <input class="form-control" type="text" name="link" id="type_customs">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#type_menu").change(function(){
            var type_menu = $("#type_menu option:selected").val();
