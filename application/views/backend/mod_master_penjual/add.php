<div class="col-sm-12">
    <div class="white-box">
        ...
        <?php $attributes = array('class'=>'form-horizontal','role'=>'form','autocomplete'=>'off'); echo form_open_multipart('penjual/tambah_penjual',$attributes); ?>
            ...
            <div class="form-group row">
                <label for="example-text-input" class="col-2 col-form-label">Nama penjual</label>
                <div class="col-10">
            ...
            <a href="<?=base_url().'penjual'?>" class="btn btn-inverse waves-effect waves-light">Batal</a>
        <?php echo form_close(); ?>
    </div>
</div>