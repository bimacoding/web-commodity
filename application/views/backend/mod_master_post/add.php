<div class="col-sm-12">
    <div class="white-box">
        ...
        <?php $attributes = array('class'=>'form-horizontal','role'=>'form','autocomplete'=>'off'); echo form_open_multipart('post/tambah_post',$attributes); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control" type="text" name="judul_post">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <textarea class="summernote" name="isi_post"></textarea>
                </div>
            </div>
