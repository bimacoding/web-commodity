<div class="col-sm-12">
    <div class="white-box">
        ...
        <?php $attributes = array('class'=>'form-horizontal','role'=>'form','autocomplete'=>'off'); echo form_open_multipart('wiget/tambah_wiget',$attributes); ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input class="form-control" type="text" name="nama_wiget">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <textarea class="form-control" name="isi_wiget"></textarea>
                </div>
            </div>
