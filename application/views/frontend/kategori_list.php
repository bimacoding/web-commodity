	...
	<div class="page_header">
		<div class="breadcrumbs">
			<ul>
				...
				<li><a href="<?=base_url().'kategori/list/'.$this->uri->segment(3)?>">Category</a></li>
				<li>Page active</li>
			</ul>
		</div>
				...
				<?php foreach ($post->result_array() as $pst) { ?>
					...
					<div class="col-md-6">
						<article class="blog">
							...
							<div class="post_info">
								<small><span class="btn btn-success btn-sm"><?=$pst['nama_kategori']?></span> - <?=$this->mylibrary->tgl_indo($pst['created_on'])?></small>
